<?php
	...
	{
		if(isset($_POST['title'], $_POST['url'], $_POST['content']))
		{
			...
			{
				$sqlQuery = $db->prepare("INSERT INTO articles (article_title, article_url, article_content, article_timestamp) VALUES (?, ?, ?, ?)");
				...
				$sqlQuery->execute();
				echo "<h1>Link succesvol geplaatst!</h1>";
						...
						<div id="blok">
							...
							<form action="add.php" method="post" autocomplete="off">
								<div class="input-group">
									<input type="text" class="form-control" name="title" placeholder="Titel"/> <br /><br />
								</div>

								<br />

								<div class="input-group">
									<input type="text" class="form-control" name="url" placeholder="URL"/> <br /><br />
								</div>
